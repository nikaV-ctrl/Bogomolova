...
import com.example.movieapptinkoff.databinding.FragmentSingleMovieBinding
import com.example.movieapptinkoff.models.Film

class SingleMovieFragment : Fragment() {

    private var mBinding: FragmentSingleMovieBinding?= null
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentSingleMovieBinding.inflate(layoutInflater, container, false)
